...
class BoardItem:
    ...
    def __init__(self):
        ...
        # Capture zones (16 positions each)
    ...
    def _populate_state_board(self):
        ...
        # Map python-chess board into rows 1–8, cols 2–9
        for rank in range(8):
            for file in range(8):
        ...
        # Fill empty capture slots with numbers
    ...
    def plan_path(self, uci_move, promotion=None):
        ...
        if piece and piece.piece_type==chess.KING and abs(end_col-start_col)>1:
            ...
            if is_promo:
                ...
                # 1️⃣ Pawn moves to above promotion piece
                path_seq.append(('promotion_pawn', astar(start_node, promo_node_above)))

                # 2️⃣ Promotion piece moves to final square
                ...
                # 3️⃣ Pawn moves down one node to promotion piece former spot
                path_seq.append(('promotion_pawn_final', [promo_node]))
            else:
